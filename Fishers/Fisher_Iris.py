...
swanlab.init(experiment_name="Fisher_iris",config={'range':100})
Accuracy = 0
...
swanlab.log({'Accuracy12':Accuracy12})
...
swanlab.log({'Accuracy13':Accuracy13})
...
swanlab.log({'Accuracy23':Accuracy23})
...
swanlab.log({"iris 1-2":swanlab.Image(plt)})
...
swanlab.log({"iris 1-3":swanlab.Image(plt)})
...
swanlab.log({"iris 2-3":swanlab.Image(plt)})
